...
public  class ExcelApiTest4
{
   public FileInputStream fis = null;
    ...
    public ExcelApiTest4(String path) {
    	this.path=path;
    }
  ...
  //getRow count starts
    ...
    //getRow count starts
      ...
      public int getColumnCount(String path, String sheetName) throws Exception
      {
    ...
    public String getCellData(String path, String sheetName,int rowNum,int column) throws Exception
    {
    	fis = new FileInputStream(path);
        workbook = new XSSFWorkbook(fis);
        sheet = workbook.getSheet(sheetName);
    ...
    public  void PutCellData(String path,String sheetName,int rowNum,int column,String Text)
    		throws Exception
    {
    ...
    public  void PutCellFormula(String path,String sheetName,int rowNum,int column,String Text)throws Exception
    {
...
/*
    ...
    */
    ...
    public  void PassPutCellData(String path,String sheetName,int rowNum,int column,String Text)throws Exception
    {
 ...
 fis = new FileInputStream(path);
    ...
    public  void FailPutCellData(String path,String sheetName,int rowNum,int column,String Text)throws Exception
    {
 ...
 fis = new FileInputStream(path);
    ...
    public  Map<String, HashMap<String, String>> getDataTable(String path,String sheetName) throws Exception
   	{
           ...
           int columnsCount=getColumnCount(path,sheetName);
           int rowsCount=getRowCount(path,sheetName);
